    ...
    <>
      <div className='mt-20 flex '>
        <div className='basis-1/2 flex h-[90vh] borde'>
          ...
          <div className='m-auto h-[60vh] w-[80%] border'>
            <div>
              ...
              <div className='text-xl font-bold mb-4'>Discover Our <span className='text-3xl'>Travel Guideline</span></div>
              <div>
                <ul className=''>
                  <li className='flex justify-center items-start relative'>
                    <div className='bg-[#41D6C7] w-10 rounded-full'><img src={Checkk} alt="" className='w-[20px]' /></div>
                  ...
                  <li className='flex justify-center items-start relative'>                    
                  <div className='bg-[#41D6C7] w-10 rounded-full'><img src={Checkk} alt="" className='w-[20px]' /></div>Pack Smart: Follow our packing lists tailored to different types of trips and climates to ensure you have everything you need.
                  </li>
                </ul>
              </div>
            </div>
